...
// wrapc file define:
#define AUTOTB_TVIN_input_layer_1 "../tv/cdatafile/c.myproject.autotvin_input_layer_1.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_layer_1, void* __xlx_apatb_param_layer13_out)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_input_layer_1;
  ...
  port1.param = (hls::stream<hls::sim::Byte<20>>*)__xlx_apatb_param_layer13_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_layer_1, __xlx_apatb_param_layer13_out);
    port1.buffer();
