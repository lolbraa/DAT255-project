...
module myproject_relu_array_ap_ufixed_16u_array_ap_ufixed_5_5_5_3_0_16u_relu_config4_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    if (((icmp_ln41_fu_68_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign i_3_fu_62_p2 = (ap_sig_allocacmp_i_2 + 10'd1);

assign icmp_ln41_fu_68_p2 = ((ap_sig_allocacmp_i_2 == 10'd675) ? 1'b1 : 1'b0);

assign layer4_out_din = layer3_out_dout;

assign start_out = real_start;

endmodule //myproject_relu_array_ap_ufixed_16u_array_ap_ufixed_5_5_5_3_0_16u_relu_config4_s
